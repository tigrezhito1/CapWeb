...
$(document).ready(function () {
    ...
    var jQueryportfolioTabs = {
        getAll: function () {
            var jQueryload = $('#load');
            $('#stats').removeClass('bottom').addClass('top');
            jQueryload.unbind();
            jQueryload.text('Load More....');
            var jQueryfilter = $('.filter');
            jQueryfilter.hide('3000');
            jQueryfilter.each(function (index) {
                $(this).addClass('even').show('3000');
            });
            jQueryload.on('click', function () {
                jQueryfilter.addClass('even');
                jQueryfilter.show("3000");
                $(this).text("No More Element..");
            });
        },
        getItems: function () {
            var jQuerygetAll = this.getAll;
...
//            $(".filter").not('.filter[filter-item="'+value+'"]').addClass('hidden');
                    ...
                    jQueryfilter.not('.' + value).hide('3000');
                    jQueryfilter.removeClass('even');
                    jQueryfilter.filter('.' + value).each(function (index) {
                        $(this).show("3000");

                    });
                    jQueryload.on('click', function () {
                        jQueryfilter.filter('.' + value).show("3000");
                        $(this).text("No More Element..");
                    });
    ...
    jQueryportfolioTabs.getItems();
    jQueryportfolioTabs.getAll();
    jQueryportfolioTabs.activeClass();
    jQueryportfolioTabs.fancybox();
    //wow .js
...
//Contact Us
    $("#submit_btn").click(function() {
                ...
                if(proceed)
                {
                        ...
                        jQuery.post('contact.php', post_data, function(response){
